...
function QueryMain() {
  ...
  const handleQuerySubmit = () => {
    ...
    const responseText = `This Agreement ("Agreement") is made and entered into as of [Date], (the "Effective Date") by and between:
    ...
    _________________________
    Bright Bulb Pvt. Ltd.`;
    const responseMessage = { type: 'bot', text: responseText };
